...
use App\Repository\IntegTypeDebiteurRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: IntegTypeDebiteurRepository::class)]
class IntegTypeDebiteur
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\ManyToOne]
    private ?TypeDebiteur $id_type_debiteur = null;
    ...
    public function getIdDebiteur(): ?TypeDebiteur
    {
        return $this->id_type_debiteur;
    }

    public function setIdDebiteur(?TypeDebiteur $id_type_debiteur): static
    {
        $this->id_type_debiteur = $id_type_debiteur;
