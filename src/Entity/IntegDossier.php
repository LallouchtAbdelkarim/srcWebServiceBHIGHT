...
use App\Repository\IntegDossierRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: IntegDossierRepository::class)]
class IntegDossier
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\Column(length: 255, nullable: true)]
    private ?string $value_num_dossier = null;

    #[ORM\Column(length: 255, nullable: true)]
    private ?string $value_ptf = null;
    ...
    public function getValueNumDossier(): ?string
    {
        return $this->value_num_dossier;
    }

    public function setValueNumDossier(?string $value_num_dossier): static
    {
        $this->value_num_dossier = $value_num_dossier;

        return $this;
    }

    public function getValuePtf(): ?string
    {
        return $this->value_ptf;
    }

    public function setValuePtf(?string $value_ptf): static
    {
        $this->value_ptf = $value_ptf;
