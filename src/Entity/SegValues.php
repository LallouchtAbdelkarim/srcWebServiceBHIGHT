...
use App\Repository\SegValuesRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: SegValuesRepository::class)]
class SegValues
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    private ?SegCritere $id_critere = null;
    ...
    public function getIdCritere(): ?SegCritere
    {
        return $this->id_critere;
    }

    public function setIdCritere(?SegCritere $id_critere): static
    {
