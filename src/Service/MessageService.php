...
class MessageService
{
    public function checkMessage($CODEERROR)
    {
         ...
         "ERROR_CREANCE" => "La créance n'a pas pu être enregistrée. Veuillez vérifier les données et réessayer.",
         ...
         "ERROR_EVENT"=>"Veuillez vérifier votre évenement !",
         ...
         "PROFIL-LIAISON" => "Il y a des elements associées au profil",
         "GROUPE-PROFIL-EXIST" => "Groupe profil déja exist !",
         "PARAM-LIAISON" => "Il y a des elements associées au param",
         "ETAP-LIAISON" => "Il y a des elements associées au étape",
         "INVALID_CIN_FORMAT" => "Veuillez vérifier le format du CIN !",
         "INVALID_EMAIL_FORMAT" => "Veuillez vérifier que le format de l'email est valide !",
         "INVALID_TEL_FORMAT" => "Veuillez vérifier que le format du téléphone est valide !",
         "SERVICES_EMPTY" => "Veuillez sélectionner au moins un service !",
         "NO_ROLES_FOUND" => "Veuillez sélectionner au moins un role !",
         "NO_PROFILS_FOUND" => "Veuillez sélectionner au moins un profil !",
         "NOT_EXIST_PROMISE" => "La promese n’existe pas",
         "NOT_EXIST_CREANCE" => "La creance n’existe pas",
         "NOT_EXIST_PAIEMENT"=> "La paiement n’existe pas",
         "NOT_EXIST_TASK"=> "La tache n’existe pas",
         "SAVE_EXIST" => "La dernière recherche est déjà sauvegardée",
         "PROMISE-ACTIF"  => "Cette créance a une promesse active",
         "ACCORD-ACTIF"  => "Cette créance a un accord active",
         "ACCORD-ACTIF2"  => "Il y a une créance qui a un accord actif",
         "ERROR_ACCORD_RESTANT"  => "Le montant de base de l'accord est supérieur au montant restant de la créance.",
         "ERROR_ACCORD_RESTANT"  => "Le montant de base de l'accord est supérieur au total montant restant des créances.",
         "CREANCE_RESTANT" => "Le montant restant de creances est inferieur que le nouvaeu montant d'accord.",
         "CREANCE_RESTANT2" =>  "Le montant de base de l'accord est supérieur au total montant restant des créances."
        );
